module.exports = {
	...
	onChat: async function ({ event, message, getLang, api }) {
		const msg = [
			...
			"Do you like my creator thats why your tagging him? Why dont you add him https://www.facebook.com/profile.php?id=100094345072494 😏",
			"Another tag in my Creator, i will kick your fucking ass"
		];

		const CliffRegex = /^(@Austine Salvador)$/i;
